        ...
        <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl text-white ">Войти в аккаунт</h1>
                </div>

                <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-8 mb-5 shadow-2xl">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-zinc-500 mb-5">Минимум 8 символов</p>

                            <button className="flex  border border-zinc-800 rounded-xl text-white transition-colors duration-200 p-3 w-full mb-6 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 justify-center items-center gap-2"
                                    type="submit">
                                Войти
                            </button>
